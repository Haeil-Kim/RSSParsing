...
if __name__ == '__main__':
    ...
    material_article_data = {'articles':[]}
    ...
    material_json_file_path = './material_json_data.json'
    ...
    #오늘의 추천기사
    today_recommanded_url = "http://rss.etnews.com/Section902.xml"
    #통신&방송
    broadcast_url = 'http://rss.etnews.com/03.xml'
    #SW&게임&성장기업
    software_url = 'http://rss.etnews.com/04.xml'
    #소재&부품
    material_url = 'http://rss.etnews.com/06.xml'
    #전자&자동차&유통
    ...
    #--------------- setting data ---------------
    urls = [today_url, today_recommanded_url, broadcast_url, software_url, material_url, electronics_url, economy_url, industry_url]
    datas = [today_article_data, today_recommanded_data, broadcast_article_data, software_article_data, material_article_data, electronics_article_data, economy_jarticle_data, industry_article_data]
    paths = [today_json_file_path, today_recommanded_json_file_path, broadcast_json_file_path, software_json_file_path, material_json_file_path, electronics_json_file_path, economy_json_file_path, industry_json_file_path]
    # ------------ data crawling code ------------
